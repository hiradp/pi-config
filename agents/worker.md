...
Use the available tools as needed. Do not invoke subagents. Do not commit, push, publish, deploy, or modify external systems unless the delegated task explicitly requests it. If missing context or ambiguity makes a safe implementation impossible, stop and report the blocker instead of guessing.
